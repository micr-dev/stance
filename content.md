...
<ol class="sources" start="34">
  ...
  <li id="source-37"><a href="https://lore.kernel.org/linux-media/CAHk-=wi4zC+Ze8e+p3tMv8TtG_80KzsZ1syL9anBtmEh5Z40vg@mail.gmail.com/">Linus Torvalds, Linux kernel mailing-list message on the "Assisted-by" tag (2026)</a>. <a class="source-backlink" href="#cite-37" aria-label="Back to citation 37">&larr;</a></li>
